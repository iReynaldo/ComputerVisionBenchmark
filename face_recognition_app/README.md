...
app = FaceRecognitionApp(model, detection_threshold=0.9, matching_threshold=0.5)
...
**Constructor:**
- `FaceRecognitionApp(model, database=None, detection_threshold=0.9, matching_threshold=0.5)`
